...
|-----------|---------|---------|
| ElevenLabs, Inc. ([policy](https://elevenlabs.io/privacy)) | Voice clone creation and voice synthesis | USA |
| OpenAI, Inc. ([policy](https://openai.com/policies/privacy-policy)) | Content moderation | USA |
| Microsoft Corporation ([policy](https://www.microsoft.com/privacy/privacystatement)) | AI conversion of profile photos | USA |
| Google LLC ([policy](https://cloud.google.com/terms/cloud-privacy-notice)) | Automatic translation | USA |
| Supabase, Inc. ([policy](https://supabase.com/privacy)) | Database, authentication, file storage, realtime | USA |
| Expo (650 Industries, Inc.) ([policy](https://expo.dev/privacy)) | Push notification delivery | USA |
| Functional Software, Inc. (Sentry) ([policy](https://sentry.io/privacy/)) | Error and fault diagnostics | USA |
| Apple Inc. / Google LLC ([Apple](https://www.apple.com/legal/privacy/) · [Google](https://firebase.google.com/support/privacy)) | Push message transmission | USA |
