export default {
    ...
    validation: {
        ...
        displayNameTaken: "이미 사용 중인 닉네임이에요",
    ...
    profile: {
        ...
        // 거부 사유는 제공자가 카테고리를 알려주지 않아 특정할 수 없다. 대신 걸리는
        // 사진의 종류를 열거해 사용자가 스스로 짐작할 수 있게 한다 — 어느 항목에
        // 걸렸는지는 여전히 비노출이라 우회 패턴 학습 차단 정책과 충돌하지 않는다.
        photoBlocked:
            "저작권, 부적절한 콘텐츠 등의 이유로 사용할 수 없는 사진이에요. 다른 사진을 선택해주세요.",
        photoRetry: "다시 시도",
    ...
    moderation: {
        ...
        // CS 이메일은 1차 출시 운영자 개인 이메일 (haru.official.app@gmail.com).
        // 정식 도메인 (support@haru.app 등) 입수 시 3 locale 동시 commit 으로 교체.
        frozen: {
            title: "안내",
            notice: "계정 이용이 일시 중지되었어요. 이의가 있으시면 haru.official.app@gmail.com 으로 문의해 주세요.",
        },
    },
